...
| **Caso de Teste** 	| **CT01 – Cadastrar perfil e realizar login ** 	|
|:---:	|:---:	|
|	Requisito Associado 	| RF-00X - A aplicação deve apresentar, na página principal, a funcionalidade de cadastro de usuários para que esses consigam criar e gerenciar seu perfil. Logo em seguida consiga efetuar o login com sucesso. |
